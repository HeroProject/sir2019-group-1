...
class DialogFlowSampleApplication(Base.AbstractApplication):
    ...
    def get_company(self, repeated=False):
        ...
        if self.company:
            if self.company != 'alone':
                ...
                print('alone')
                self.sayAnimated('You came here alone from ' + self.origin + '? That must have been a tough journey to undertake by yourself.')
                self.speechLock.acquire()
        else:
    ...
    def main(self):
        ...
        sleep(1)
        self.sayAnimated('OK ' + self.name + '. We would like to know why you came to The Netherlands. Can you please answer the following '
